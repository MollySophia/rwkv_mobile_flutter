...
class rwkv_mobile {
  ...
  int rwkvmobile_runtime_get_available_backend_names(ffi.Pointer<ffi.Char> backend_names_buffer, int buffer_size) {
    return _rwkvmobile_runtime_get_available_backend_names(backend_names_buffer, buffer_size);
  }
  ...
  rwkvmobile_runtime_t rwkvmobile_runtime_init_with_name_extra(ffi.Pointer<ffi.Char> backend_name, ffi.Pointer<ffi.Void> extra) {
    return _rwkvmobile_runtime_init_with_name_extra(backend_name, extra);
  }
  ...
  int rwkvmobile_runtime_load_model(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> model_path) {
    return _rwkvmobile_runtime_load_model(runtime, model_path);
  }
  ...
  int rwkvmobile_runtime_load_tokenizer(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> vocab_file) {
    return _rwkvmobile_runtime_load_tokenizer(runtime, vocab_file);
  }
  ...
  int rwkvmobile_runtime_eval_logits(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Int> ids, int ids_len, ffi.Pointer<ffi.Float> logits, int logits_len) {
    return _rwkvmobile_runtime_eval_logits(runtime, ids, ids_len, logits, logits_len);
  }
  ...
  int rwkvmobile_runtime_eval_chat(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> input, int max_tokens, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>> callback, int enable_reasoning) {
    return _rwkvmobile_runtime_eval_chat(runtime, input, max_tokens, callback, enable_reasoning);
  }

  late final _rwkvmobile_runtime_eval_chatPtr = _lookup<ffi.NativeFunction<ffi.Int Function(rwkvmobile_runtime_t, ffi.Pointer<ffi.Char>, ffi.Int, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>>, ffi.Int)>>('rwkvmobile_runtime_eval_chat');
  ...
  int rwkvmobile_runtime_eval_chat_with_history(rwkvmobile_runtime_t handle, ffi.Pointer<ffi.Pointer<ffi.Char>> inputs, int num_inputs, int max_tokens, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>> callback, int enable_reasoning) {
    return _rwkvmobile_runtime_eval_chat_with_history(handle, inputs, num_inputs, max_tokens, callback, enable_reasoning);
  }

  late final _rwkvmobile_runtime_eval_chat_with_historyPtr = _lookup<ffi.NativeFunction<ffi.Int Function(rwkvmobile_runtime_t, ffi.Pointer<ffi.Pointer<ffi.Char>>, ffi.Int, ffi.Int, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>>, ffi.Int)>>('rwkvmobile_runtime_eval_chat_with_history');
  ...
  int rwkvmobile_runtime_set_prompt(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> prompt) {
    return _rwkvmobile_runtime_set_prompt(runtime, prompt);
  }
  ...
  int rwkvmobile_runtime_get_prompt(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> prompt, int buf_len) {
    return _rwkvmobile_runtime_get_prompt(runtime, prompt, buf_len);
  }
  ...
  int rwkvmobile_runtime_gen_completion(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> prompt, int max_tokens, int stop_code, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>> callback) {
    return _rwkvmobile_runtime_gen_completion(runtime, prompt, max_tokens, stop_code, callback);
  }
  ...
  int rwkvmobile_runtime_gen_completion_blocking(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> prompt, int max_tokens, int stop_code, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>> callback) {
    return _rwkvmobile_runtime_gen_completion_blocking(runtime, prompt, max_tokens, stop_code, callback);
  }

  late final _rwkvmobile_runtime_gen_completion_blockingPtr = _lookup<ffi.NativeFunction<ffi.Int Function(rwkvmobile_runtime_t, ffi.Pointer<ffi.Char>, ffi.Int, ffi.Int, ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<ffi.Char>, ffi.Int)>>)>>('rwkvmobile_runtime_gen_completion_blocking');
  ...
  void rwkvmobile_runtime_set_sampler_params(rwkvmobile_runtime_t runtime, sampler_params params) {
    return _rwkvmobile_runtime_set_sampler_params(runtime, params);
  }
  ...
  void rwkvmobile_runtime_set_penalty_params(rwkvmobile_runtime_t runtime, penalty_params params) {
    return _rwkvmobile_runtime_set_penalty_params(runtime, params);
  }
  ...
  int rwkvmobile_runtime_load_vision_encoder(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> encoder_path) {
    return _rwkvmobile_runtime_load_vision_encoder(runtime, encoder_path);
  }
  ...
  int rwkvmobile_runtime_set_image_prompt(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> image_path) {
    return _rwkvmobile_runtime_set_image_prompt(runtime, image_path);
  }
  ...
  int rwkvmobile_runtime_load_whisper_encoder(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> encoder_path) {
    return _rwkvmobile_runtime_load_whisper_encoder(runtime, encoder_path);
  }
  ...
  int rwkvmobile_runtime_set_audio_prompt(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> audio_path) {
    return _rwkvmobile_runtime_set_audio_prompt(runtime, audio_path);
  }
  ...
  int rwkvmobile_runtime_set_token_banned(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Int> token_banned, int token_banned_len) {
    return _rwkvmobile_runtime_set_token_banned(runtime, token_banned, token_banned_len);
  }
  ...
  int rwkvmobile_runtime_set_eos_token(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> eos_token) {
    return _rwkvmobile_runtime_set_eos_token(runtime, eos_token);
  }
  ...
  int rwkvmobile_runtime_set_bos_token(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> bos_token) {
    return _rwkvmobile_runtime_set_bos_token(runtime, bos_token);
  }
  ...
  int rwkvmobile_runtime_set_user_role(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> user_role) {
    return _rwkvmobile_runtime_set_user_role(runtime, user_role);
  }
  ...
  int rwkvmobile_runtime_set_response_role(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> response_role) {
    return _rwkvmobile_runtime_set_response_role(runtime, response_role);
  }
  ...
  int rwkvmobile_runtime_set_thinking_token(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> thinking_token) {
    return _rwkvmobile_runtime_set_thinking_token(runtime, thinking_token);
  }
  ...
  int rwkvmobile_runtime_cosyvoice_load_models(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> speech_tokenizer_path, ffi.Pointer<ffi.Char> campplus_path, ffi.Pointer<ffi.Char> flow_encoder_path, ffi.Pointer<ffi.Char> flow_decoder_estimator_path, ffi.Pointer<ffi.Char> hift_generator_path, ffi.Pointer<ffi.Char> tts_tokenizer_path, ffi.Pointer<ffi.Char> spk_info_path) {
    return _rwkvmobile_runtime_cosyvoice_load_models(runtime, speech_tokenizer_path, campplus_path, flow_encoder_path, flow_decoder_estimator_path, hift_generator_path, tts_tokenizer_path, spk_info_path);
  }
  ...
  int rwkvmobile_runtime_run_tts(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> tts_text, ffi.Pointer<ffi.Char> instruction_text, ffi.Pointer<ffi.Char> prompt_wav_path, ffi.Pointer<ffi.Char> output_wav_path) {
    return _rwkvmobile_runtime_run_tts(runtime, tts_text, instruction_text, prompt_wav_path, output_wav_path);
  }
  ...
  int rwkvmobile_runtime_run_tts_with_predefined_spks(rwkvmobile_runtime_t runtime, ffi.Pointer<ffi.Char> tts_text, ffi.Pointer<ffi.Char> instruction_text, ffi.Pointer<ffi.Char> spk_name, ffi.Pointer<ffi.Char> output_wav_path) {
    return _rwkvmobile_runtime_run_tts_with_predefined_spks(runtime, tts_text, instruction_text, spk_name, output_wav_path);
  }

  late final _rwkvmobile_runtime_run_tts_with_predefined_spksPtr = _lookup<ffi.NativeFunction<ffi.Int Function(rwkvmobile_runtime_t, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>, ffi.Pointer<ffi.Char>)>>('rwkvmobile_runtime_run_tts_with_predefined_spks');
  ...
  late final _rwkvmobile_runtime_cosyvoice_get_spk_namesPtr = _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function(rwkvmobile_runtime_t)>>('rwkvmobile_runtime_cosyvoice_get_spk_names');
