...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "application_internal_test_group":
            MessageLookupByLibrary.simpleMessage("應用程式內測群"),
        ...
        "bot_message_edited":
            MessageLookupByLibrary.simpleMessage("機器人訊息已編輯，現在可以傳送新訊息"),
        ...
        "chat_please_select_a_model":
            MessageLookupByLibrary.simpleMessage("請選擇一個模型"),
        ...
        "choose_prebuilt_character":
            MessageLookupByLibrary.simpleMessage("選擇預設角色"),
        "clear": MessageLookupByLibrary.simpleMessage("清除"),
        "click_here_to_select_a_new_model":
            MessageLookupByLibrary.simpleMessage("點擊此處選擇新模型"),
        "click_here_to_start_a_new_chat":
            MessageLookupByLibrary.simpleMessage("點擊此處開始新聊天"),
        ...
        "continue_using_smaller_model":
            MessageLookupByLibrary.simpleMessage("繼續使用較小模型"),
        ...
        "difficulty_must_be_greater_than_0":
            MessageLookupByLibrary.simpleMessage("難度必須大於 0"),
        "difficulty_must_be_less_than_81":
            MessageLookupByLibrary.simpleMessage("難度必須小於 81"),
        ...
        "filter":
            MessageLookupByLibrary.simpleMessage("你好，這個問題我暫時無法回答，讓我們換個話題再聊聊吧。"),
        ...
        "follow_us_on_twitter":
            MessageLookupByLibrary.simpleMessage("在 Twitter 上關注我們"),
        ...
        "generate_random_sudoku_puzzle":
            MessageLookupByLibrary.simpleMessage("生成隨機數獨"),
        ...
        "hold_to_record_release_to_send":
            MessageLookupByLibrary.simpleMessage("按住錄音，鬆開發送"),
        "human": MessageLookupByLibrary.simpleMessage("人類"),
        "i_want_rwkv_to_say":
            MessageLookupByLibrary.simpleMessage("我想讓 RWKV 說..."),
        "imitate": m2,
        ...
        "join_our_discord_server":
            MessageLookupByLibrary.simpleMessage("加入我們的 Discord 伺服器"),
        ...
        "or_you_can_start_a_new_empty_chat":
            MessageLookupByLibrary.simpleMessage("或開始一個空白聊天"),
        ...
        "playing_partial_generated_audio":
            MessageLookupByLibrary.simpleMessage("正在播放部分已生成的語音"),
        "please_check_the_result":
            MessageLookupByLibrary.simpleMessage("請檢查結果"),
        "please_enter_a_number_0_means_empty":
            MessageLookupByLibrary.simpleMessage("請輸入一個數字。0 表示空。"),
        "please_enter_the_difficulty":
            MessageLookupByLibrary.simpleMessage("請輸入難度"),
        "please_grant_permission_to_use_microphone":
            MessageLookupByLibrary.simpleMessage("請授予使用麥克風的權限"),
        "please_load_model_first":
            MessageLookupByLibrary.simpleMessage("請先載入模型"),
        "please_select_a_world_type":
            MessageLookupByLibrary.simpleMessage("請選擇 World 類型"),
        "please_select_application_language":
            MessageLookupByLibrary.simpleMessage("請選擇應用程式語言"),
        "please_select_font_size":
            MessageLookupByLibrary.simpleMessage("請選擇字體大小"),
        "please_wait_for_it_to_finish":
            MessageLookupByLibrary.simpleMessage("請等待推論完成"),
        ...
        "please_wait_for_the_model_to_load":
            MessageLookupByLibrary.simpleMessage("請等待模型載入"),
        ...
        "select_a_world_type":
            MessageLookupByLibrary.simpleMessage("選擇 World 類型"),
        "send_message_to_rwkv":
            MessageLookupByLibrary.simpleMessage("傳送訊息給 RWKV"),
        ...
        "size_recommendation":
            MessageLookupByLibrary.simpleMessage("推薦至少選擇 1.5B 模型，效果更好"),
        ...
        "technical_research_group":
            MessageLookupByLibrary.simpleMessage("技術研發群"),
        ...
        "you_can_now_start_to_chat_with_rwkv":
            MessageLookupByLibrary.simpleMessage("現在可以開始與 RWKV 聊天了"),
        ...
        "you_can_select_a_role_to_chat":
            MessageLookupByLibrary.simpleMessage("您可以選擇角色進行聊天"),
        "your_voice_is_too_short":
            MessageLookupByLibrary.simpleMessage("您的聲音太短，請長按按鈕更久以獲取您的聲音。")
      };
}
