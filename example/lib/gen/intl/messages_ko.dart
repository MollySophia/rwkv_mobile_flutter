...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(memUsed, memFree) => "사용 중 메모리: ${memUsed}, 여유 메모리: ${memFree}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "chat_you_need_download_model_if_you_want_to_use_it": MessageLookupByLibrary.simpleMessage("사용하려면 먼저 모델을 다운로드해야 합니다"),
        ...
        "start_a_new_chat_by_clicking_the_button_below": MessageLookupByLibrary.simpleMessage("아래 버튼을 클릭하여 새 채팅 시작"),
