...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "chat_you_need_download_model_if_you_want_to_use_it": MessageLookupByLibrary.simpleMessage("使用するにはモデルのダウンロードが必要です"),
        ...
        "ensure_you_have_enough_memory_to_load_the_model": MessageLookupByLibrary.simpleMessage("メモリが不足するとアプリがクラッシュする可能性があります"),
        ...
        "start_a_new_chat_by_clicking_the_button_below": MessageLookupByLibrary.simpleMessage("下のボタンをクリックして新規チャットを開始"),
