...
class _App with WidgetsBindingObserver {
  ...
  final _pageKey = _gs(() {
    if (Config.firstPageIsHome) return PageKey.home;
    if (Config.firstPageIsChat) return PageKey.chat;
    if (Config.firstPageIsOthello) return PageKey.othello;
    return PageKey.empty;
  }());
